...
import { VehicleTypeUpdateOneWithoutVehicleNestedInput } from "../inputs/VehicleTypeUpdateOneWithoutVehicleNestedInput";
import { VehicleUnprocessedUpdateEnvelopeInput } from "../inputs/VehicleUnprocessedUpdateEnvelopeInput";

@InputType("VehicleUpdateWithoutSeriesInput", {})
export class VehicleUpdateWithoutSeriesInput {
  ...
  @Field(_type => VehicleTypeUpdateOneWithoutVehicleNestedInput, {
    nullable: true
  })
  vehicleType?: VehicleTypeUpdateOneWithoutVehicleNestedInput | undefined;
