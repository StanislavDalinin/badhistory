...
import { VehicleCreateNestedOneWithoutLotsInput } from "../inputs/VehicleCreateNestedOneWithoutLotsInput";
import { Auction } from "../../enums/Auction";

@InputType("LotCreateInput", {})
export class LotCreateInput {
  ...
  @Field(_type => VehicleCreateNestedOneWithoutLotsInput, {
    nullable: false
  })
