...
import { VehicleUpdateOneRequiredWithoutLotsNestedInput } from "../inputs/VehicleUpdateOneRequiredWithoutLotsNestedInput";

@InputType("LotUpdateInput", {})
export class LotUpdateInput {
  ...
  @Field(_type => VehicleUpdateOneRequiredWithoutLotsNestedInput, {
    nullable: true
  })
  vehicle?: VehicleUpdateOneRequiredWithoutLotsNestedInput | undefined;
}
