...
import { ResumableProcessMirrorCreateNestedOneWithoutSubProcessesInput } from "../inputs/ResumableProcessMirrorCreateNestedOneWithoutSubProcessesInput";
import { ResumableProcessType } from "../../enums/ResumableProcessType";
import { Status } from "../../enums/Status";

@InputType("ResumableProcessMirrorCreateWithoutSubProcessesInput", {})
export class ResumableProcessMirrorCreateWithoutSubProcessesInput {
  @Field(_type => String, {
    nullable: true
  })
  id?: string | undefined;
  ...
  @Field(_type => ResumableProcessMirrorCreateNestedOneWithoutSubProcessesInput, {
    nullable: true
  })
  parentProcess?: ResumableProcessMirrorCreateNestedOneWithoutSubProcessesInput | undefined;
}
