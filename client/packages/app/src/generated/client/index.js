...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "../client/packages/app/src/generated/client",
    "client/packages/app/src/generated/client",
  ]
...
path.join(process.cwd(), "../client/packages/app/src/generated/client/libquery_engine-darwin.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "../client/packages/app/src/generated/client/schema.prisma")
